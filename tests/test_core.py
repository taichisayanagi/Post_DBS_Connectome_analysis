...
class ProvenanceTests(SyntheticFixture):
    ...
    def test_prepared_pipeline_plan(self):
        ...
        self.assertTrue(commands[0][2].endswith("tracks_mrtrix_excluded.tck"))
        self.assertTrue(commands[1][1].endswith("tracks_excluded.tck"))
        self.assertEqual(commands[2][1], commands[1][1])
